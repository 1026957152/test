...
func command_update(client MQTT.Client, message Downlinks) {
	...
	if message.Command == "update" {
		...
		if message.Confirmed == true {
			...
			cf, err := update.DownloadFile_("~"+string(os.PathSeparator)+"a.txt", "https://raw.githubusercontent.com/idreamsi/RadioHead/master/LICENSE")
			if err != nil {
